...
% of extraction, SD increases or flattens but not decreases(if sd is
% similarity; otherwise,  if sd is sample distance, it would decrease or flatten)
% the number of clustering is determined, the following extraction is the refinement approach.
%written by chen wei
